...
// Get synchronously retrieves the peer with the given id from the peerstore
...
func (p *Peer) RequestHandler() {
	...
	for {
		...
		case message.ResourcePeerInfo, message.ResourceBlock, message.ResourceTransaction:
